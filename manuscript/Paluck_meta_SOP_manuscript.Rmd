...
Of our three meta-analyses, @paluck2019 most closely hews to this model of inquiry by looking solely at randomized controlled trials where intergroup contact was the treatment variable and where there was at least a day of delay between the commencement of treatment and outcome measurement. (Admittedly we could have tightened our study even further by looking for harmonized dependent variables, but given the diversity of outcomes we found, that would have effectively precluded meta-analysis.) Our subsequent two meta-analyses [@paluck2021; @porat2024], however, are much more clearly at risk of the kinds of incoherence that recent critics identify. Both studies:
  ...
  2. combine papers that are drawing from vastly different theoretical traditions, and therefore cannot clearly be integrated coherently (e.g., within the sexual violence literature, a building-based intervention that induced "higher levels of faculty/security presence in safe/unsafe 'hot spots' mapped by students" [@taylor2013], and a module of peer-based consent training on a college campus)
  3. 
