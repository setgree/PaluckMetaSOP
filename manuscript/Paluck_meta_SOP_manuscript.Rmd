...
The main goals of our meta-analysis are the goals of any systematic review: to evaluate a body of knowledge for its strengths, weaknesses, central findings, open questions and empirical limitations. We write broadly for any reader who is interested in the underlying question, but generally aim for a non-specialist audience. In our experience, a literature's most noteworthy contributions often come from researchers outside the core field (e.g. @mousa2020,  @boisjoly2006, or @scacco2018 for the contact hypothesis, @munger2017 for anti-prejudice work, or @haushofer2019 for violence against women); to such researchers, we aim to provide signposts, in the form of unearthed, widespread empirical gaps and theoretical limitations, about where future empirical work will be most valuable. 
...
We also encourage authors not to be discouraged from writing meta-analyses even if the subject has previously, even many times, been systematically reviewed and quantitatively analyzed. First, in our experience, simply reproducing the analyses of previous meta-analyses verbatim might generate surprises. For example, Pettigrew & Troop's landmark meta-analysis -@pettigrew2006 identified 515 studies and 36 "true experiments" (p. 759) on intergroup contact; however, when we took a look at these papers for ourselves, we found that many "did not have over-time outcome measures, were mislabeled as randomly assigned, did not feature 'actual face-to-face interaction' or did not have a non-contact control group," and we were ultimately "left with eight research reports comprising nine experiments" [@paluck2019, p. 136]. Second, we share Munger's -@munger2021 concern for 'temporal validity,' the idea that "no research design, no empirical knowledge, is perfectible" because the conditions under which social science findings hold might change dramatically over time. For instance, the implicit bias [@gawronski2019] and symbolic racism [@mcconahay1976; @sears2003]

four reasons to not take other metas for granted
1) you redo their stats and find different stuff
2) temporal validity
3) incompleteness 
4) non-quantitative outcomes
Many previous systematic reviews ? Not a problem
    actually be careful to replicate
