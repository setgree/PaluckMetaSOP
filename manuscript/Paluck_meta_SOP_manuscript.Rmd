...
The main goals of our meta-analysis are the goals of any systematic review: to evaluate a body of knowledge for its strengths, weaknesses, central findings, open questions and empirical limitations. We write broadly for any reader who is interested in the underlying question, but generally aim for a non-specialist audience. In our experience, a literature's most noteworthy contributions often come from researchers outside the core field (e.g. @mousa2020,  @boisjoly2006, or @scacco2018 for the contact hypothesis, @munger2017 for anti-prejudice work, or @haushofer2019 for violence against women), which is why we aim to give outsiders an overview of a literature's main preoccupations and conclusions. The theoretical and empirical gaps unearthed by meta-analysis are also signposts to ourselves about where future empirical work will be most valuable. 
