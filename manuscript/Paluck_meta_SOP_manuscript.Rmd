...
Our meta-analyses share these goals (and @paluck2021 is cited therein as a "selective, design-focused, and evaluative" meta-analysis). Moreover, the authors note that typical guides to meta-analysis "briefly mention validity concerns but provide little guidance as to how to carry out quality control;" one of the aims of this paper is to provide such guidance. However, as mentioned above, we part ways from this paper in that we believe comprehensive meta-analytic estimates still have a place in the meta-scientist's toolkit, so long as those estimates are ascribed descriptive rather than causal meaning and are used to contextualize further, more selective analyses. 

Our paper is a hybrid of conceptual work and granular guidance to researchers. In the latter respect, this paper builds on a tradition of Standard Operating Procedures in the behavioral and medical sciences. Most of these papers are written to standardize practices at the level of a class of research, e.g. clinical trials [@rapport2013] or  medical procedures [@wallace2015]; @lakens2023 provides guidance for deviating from pre-analysis plans. However, to our knowledge, just one previous paper in the behavioral sciences describe's a _lab's_ approach to a particular research task [@lin2016]; this paper builds closely on that one and was partly inspired by it. We hope to see more papers in this vein describing lab- or department-based approaches to research.

Last, this paper is spiritually kin to papers that attempt to integrate particular practices into the field of meta-science [munger]
