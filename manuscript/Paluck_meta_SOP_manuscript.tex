...
\abstract{%
This paper describes the motivations and procedures for meta-analyses by Betsy Levy Paluck and co-authors, with reference to and examples drawn from three such papers (Paluck, Green, and Green 2019, Paluck et al.~2020, and Porat et al.~2024). We first describe our conceptual aims when writing meta-analytic papers, including where we think meta-analyses provide value beyond non-quantitative reviews and how we think through the trade-off between comprehensive and selective inclusion criteria. Second, we describe the typical `flow' of the papers as a whole. Third, we describe our meta-analytic procedures, detailing our default analytic choices and introducing an R package that implements those choices package. We conclude with some open questions for meta-analysts.
}
