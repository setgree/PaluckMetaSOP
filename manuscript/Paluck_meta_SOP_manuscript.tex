...
\section{Comprehensive vs.~selective meta-analayses: a time and a place for each}\label{comprehensive-vs.-selective-meta-analayses-a-time-and-a-place-for-each}

The simplest, conceptually clearest way to address the critiques of Slough and Tyson (2023) and Simonsohn et al. (2022) is to set strict inclusion criteria relating to study design, class of intervention, and measurement strategy. We think such a paper can make a valuable contribution, in no small part by revealing a paucity of rigorous evidence, as Paluck et al. (2019) did for the intergroup contact literature.

we think that coding a wide variety of designs, treatments, and outcomes helps illuminate some essential meta-scientific quantities.
