...
\paragraph{Four reasons to prefer comprehensive, inclusive meta-analyses}\label{four-reasons-to-prefer-comprehensive-inclusive-meta-analyses}
...
Third, coding a wide variety of interventions allows for subsequent analyses to focus on the effects of particular interventions, or classes of intervention, and comparing them. Again, the overall meta-analytic estimate provides a backdrop to these more focused analyses.
...
We do not expect anything in this section to be groundbreaking or especially interesting. However, we think there is pedagogical value in explicitly sharing a lab's approach to a class of paper. We hope to see more papers in this veins as a way of identifying and disseminating best practices.

\subsubsection{How our meta-analyses typically unfold}\label{how-our-meta-analyses-typically-unfold}

First, our meta-analyses' introductions describe the context and stakes of the paper.

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Describe context and stakes of the paper (i.e.~why it's important to see if these interventions `work', or why there is reason to doubt an established consensus)
\item
