...
Slough and Tyson (2023) and (\textbf{simmons2022?}) have raised trenchant critiques about whether the typical meta-analytic estimate is meaningful. Both papers argue for the use of inclusion criteria in study selection \textemdash Slough and Tyson to assure harmonization of the independent and dependent variables, and Simmons et al.~to prevent mixing ``studies of the highest quality'' with ``studies that lack internal validity.''
