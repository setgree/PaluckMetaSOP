...
### These vignettes are aimed at helping with steps 4-6.
...
The [second vignette](meta-analysis-vignette.html) is about **step 5**, how to actually do meta-analysis, i.e. combine your point estimates into pooled estimates that tell you about overall effects and subgroup effects.

The [third vignette](writing-metas-vignette.html) is about **step 6**, and walks through the other functions we've written to help write a meta-analysis paper. Specifically, it covers summary statistics, turning your meta-analytic database into a bibliography, and ggplot2-based visualizations.
