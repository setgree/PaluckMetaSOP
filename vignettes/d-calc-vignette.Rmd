...
The contact hypothesis meta-analytic dataset is included, with small adjustments, in this package as `PaluckMetaSOP::contact_data`. [The Contact Hypothesis Re-evaluated](https://doi.org/10.1017/bpp.2018.25)'s supplementary materials, including all studies discussed here, are available on the [Open Science Framework](https://osf.io/ttpvy/?view_only=https://osf.io/ttpvy/?view_only=).
...
We now load the `PaluckMetaSOP` library, which has the `d_calc` and `var_d_calc` functions. We'll also load the `contact_data` dataset from [The Contact Hypothesis Re-evaluated](https://doi.org/10.1017/bpp.2018.25) for reference.
...
#### 3.2.3 log odds ratios, odds ratios, and a novel difference in proportions estimator: {#section323}
...
[Performing meta-analysis the Paluck Lab way](03-meta-analysis-vignette.html).
