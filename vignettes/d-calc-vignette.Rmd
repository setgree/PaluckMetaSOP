...
$$SMD = \frac{5.708 - 3.0789}{1.0381} = 2.533$$
...
Two notes about this effect size. First, you'll see a "what" column in our dataset that, for this study, says "Table 4.9 (p. 79)." This is a signpost — both for the meta-analyst, her co-authors, and for any interested readers — about which statistics you've converted into ∆. We highly recommend that you record signposts like this when you're recording data.

Second, ∆ = 2.533 is a very large effect size**.** Most effect sizes across all meta-analyses we've written as a lab are between -1 and 1.
