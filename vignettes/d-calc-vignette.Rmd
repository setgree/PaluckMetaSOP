...
Second, if a simple regression model is reported without any controls, you can divide $\beta$ by $se$ to get the T-statitic, which can be converted to $d$ in a routinized way with `d_calc`. [^8]
