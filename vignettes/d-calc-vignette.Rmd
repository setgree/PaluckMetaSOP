...
### The core parameters:
`d_calc` takes in 4-5 inputs:
* `stat_type`, which is the kind of statistical information a study presents results as
`stat`, which is the value of that stat_type (e.g. F = 1.0 or reg_coef (regression coefficient) = 0.2)
