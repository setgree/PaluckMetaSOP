...
Now that we [have our vectors of ∆, variance, and standard errors for each paper](02-d-calc-vignette.html), it's time to perform a meta-analysis, i.e. the statistical procedure by which the results of many studies are pooled. 
...
## 4 Next up
[Writing your meta-analytic paper](04-writing-metas-vignette.html).
