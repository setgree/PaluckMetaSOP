...
```{r se_d_plot, tidy=TRUE, warning=FALSE, message=FALSE}
library(ggrepel)
...
Fair warning that a perfectionist could spend the rest of her natural life tinkering with ggplot code. At some point, you just have to decide that the plot is good enough for publication 😃
